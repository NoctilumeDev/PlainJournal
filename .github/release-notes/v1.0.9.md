...
候选提交已通过仓库结构、文档、版本、Compose 和发布材料门禁；后端 436 项测试、
72.42% 行覆盖率和 12 份零违规 PMD 报告通过，前端 323 项单元/契约测试、60 项开发态
E2E、3 项生产构建 E2E、70.16% 行覆盖率与依赖审计通过。最终 `main` 提交和 Release
资产仍按发布阶段分别回读。既有真实中间件、三实例、容量和 Chromium F12/CDP 证据
保持原验证边界，不把本次维护回归表述为重新执行的真实基础设施实验。
