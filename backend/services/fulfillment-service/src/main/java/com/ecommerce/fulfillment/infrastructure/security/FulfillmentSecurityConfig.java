...
public class FulfillmentSecurityConfig {
    ...
    @Bean
    public SecretKey fulfillmentJwtSecretKey(FulfillmentTokenProperties properties) {
        return new SecretKeySpec(properties.secret().getBytes(StandardCharsets.UTF_8), "HmacSHA256");
    }

    @Bean
    public JwtDecoder fulfillmentJwtDecoder(
            SecretKey fulfillmentJwtSecretKey,
            FulfillmentTokenProperties properties) {
        NimbusJwtDecoder decoder = NimbusJwtDecoder.withSecretKey(fulfillmentJwtSecretKey)
