...
@ConfigurationProperties("ecommerce.fulfillment.after-sale-consumer")
public record AfterSaleEventConsumerProperties(
        boolean enabled,
        String endpoints,
        String topic,
    ...
    public AfterSaleEventConsumerProperties {
        endpoints = endpoints == null ? "127.0.0.1:18082" : endpoints;
        topic = topic == null ? "ecommerce-order-events" : topic;
        consumerGroup = consumerGroup == null ? "fulfillment-after-sale-approved-v1" : consumerGroup;
