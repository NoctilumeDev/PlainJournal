...
public class ConsumerFailureRecorder {
    ...
    private boolean record(
        ...
        int changes = shardRouter.executeOnShard(0, () -> {
    ...
    public void markRecovered(MessageView message, String consumerGroup) {
        int updated = shardRouter.executeOnShard(0, () -> mapper.markRecovered(
                message.getMessageId().toString(), consumerGroup, mapper.currentTime()));
        if (updated > 0) {
