...
@ConfigurationProperties("ecommerce.trade.fulfillment-consumer")
public record FulfillmentEventConsumerProperties(
        boolean enabled,
        String endpoints,
        String topic,
    ...
    public FulfillmentEventConsumerProperties {
        endpoints = endpoints == null ? "127.0.0.1:18082" : endpoints;
        topic = topic == null ? "ecommerce-logistics-events" : topic;
        consumerGroup = consumerGroup == null ? "trade-fulfillment-events-v1" : consumerGroup;
