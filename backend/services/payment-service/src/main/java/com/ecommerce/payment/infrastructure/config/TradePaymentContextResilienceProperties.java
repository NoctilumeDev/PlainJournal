...
@ConfigurationProperties("ecommerce.payment.client.trade-payment-context")
public record TradePaymentContextResilienceProperties(
    ...
    public TradePaymentContextResilienceProperties {
    ...
    private static IllegalArgumentException invalid(String message) {
        return new IllegalArgumentException(
                "ecommerce.payment.client.trade-payment-context." + message);
    }
}
