...
@Validated
@ConfigurationProperties("ecommerce.notification.events")
public record NotificationEventConsumerProperties(
        boolean enabled,
        @NotBlank String endpoints,
        @NotBlank String consumerGroup,
        @NotBlank String paymentTopic,
        @NotBlank String logisticsTopic,
    ...
    public NotificationEventConsumerProperties {
        endpoints = defaultText(endpoints, "127.0.0.1:18082");
        consumerGroup = defaultText(consumerGroup, "ecommerce-notification-domain-events");
        paymentTopic = defaultText(paymentTopic, "ecommerce-payment-events");
        logisticsTopic = defaultText(logisticsTopic, "ecommerce-logistics-events");
