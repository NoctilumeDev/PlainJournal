...
public class NotificationSecurityConfig {
    ...
    @Bean
    public SecretKey notificationJwtSecretKey(NotificationTokenProperties properties) {
    ...
    @Bean
    public JwtDecoder notificationJwtDecoder(
            SecretKey notificationJwtSecretKey,
            NotificationTokenProperties properties) {
        NimbusJwtDecoder decoder = NimbusJwtDecoder.withSecretKey(notificationJwtSecretKey)
