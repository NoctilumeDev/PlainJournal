...
function Stop-FoundationServices {
    ...
    foreach ($processId in $processIds) {
        ...
        $isFoundationService = $process.CommandLine -like '*ecommerce-gateway.jar*' -or
            $process.CommandLine -like '*identity-service.jar*' -or
            $process.CommandLine -like '*catalog-service.jar*' -or
            $process.CommandLine -like '*inventory-service.jar*' -or
            $process.CommandLine -like '*trade-service.jar*' -or
            $process.CommandLine -like '*payment-service.jar*' -or
            $process.CommandLine -like '*fulfillment-service.jar*' -or
            $process.CommandLine -like '*marketing-service.jar*'
...
$identityJar = Join-Path $PSScriptRoot 'services\identity-service\target\identity-service.jar'
$catalogJar = Join-Path $PSScriptRoot 'services\catalog-service\target\catalog-service.jar'
$inventoryJar = Join-Path $PSScriptRoot 'services\inventory-service\target\inventory-service.jar'
$tradeJar = Join-Path $PSScriptRoot 'services\trade-service\target\trade-service.jar'
$paymentJar = Join-Path $PSScriptRoot 'services\payment-service\target\payment-service.jar'
$fulfillmentJar = Join-Path $PSScriptRoot 'services\fulfillment-service\target\fulfillment-service.jar'
$marketingJar = Join-Path $PSScriptRoot 'services\marketing-service\target\marketing-service.jar'
$gatewayJar = Join-Path $PSScriptRoot 'ecommerce-gateway\target\ecommerce-gateway.jar'
