...
function Stop-BaselineServices {
    $expectedJarByPort = @{
        18000 = 'ecommerce-gateway-0.1.0-SNAPSHOT.jar'
        18101 = 'identity-service-0.1.0-SNAPSHOT.jar'
        18102 = 'catalog-service-0.1.0-SNAPSHOT.jar'
        18104 = 'trade-service-0.1.0-SNAPSHOT.jar'
    }
...
$gatewayJar = Join-Path $script:backendRoot 'ecommerce-gateway\target\ecommerce-gateway-0.1.0-SNAPSHOT.jar'
$identityJar = Join-Path $script:backendRoot 'services\identity-service\target\identity-service-0.1.0-SNAPSHOT.jar'
$catalogJar = Join-Path $script:backendRoot 'services\catalog-service\target\catalog-service-0.1.0-SNAPSHOT.jar'
$tradeJar = Join-Path $script:backendRoot 'services\trade-service\target\trade-service-0.1.0-SNAPSHOT.jar'
