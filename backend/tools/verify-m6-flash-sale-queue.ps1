...
try {
    ...
    $jars = @{
        identity = Join-Path $script:backendRoot 'services\identity-service\target\identity-service.jar'
        catalog = Join-Path $script:backendRoot 'services\catalog-service\target\catalog-service.jar'
        inventory = Join-Path $script:backendRoot 'services\inventory-service\target\inventory-service.jar'
        trade = Join-Path $script:backendRoot 'services\trade-service\target\trade-service.jar'
        payment = Join-Path $script:backendRoot 'services\payment-service\target\payment-service.jar'
        marketing = Join-Path $script:backendRoot 'services\marketing-service\target\marketing-service.jar'
        gateway = Join-Path $script:backendRoot 'ecommerce-gateway\target\ecommerce-gateway.jar'
    }
